...
<head>
    @include('landing.layouts.head' , ['title' => __('translate.reset_password')])
</head>
<body>
<!-- begin:: Page -->
            ...
            <div class="row row-height">
                ...
                <div class="col-lg-6 content-left">
                    <div class="content-left-wrapper">
                        ...
                        {!! Form::open(['method'=>'POST', 'url'=> route('user.auth.password.email') , 'class' => 'form-resetPass' , 'id'=>'form']) !!}
                            <div class="form-group">
                                <div class="input-icon">
                                    <input class="form-control" type="text" name="email" placeholder="@lang('translate.email')" />
                                    <div class="input-icon__icon"><i class="icon-envelope-2"></i></div>
                                </div>
                            </div>
                            <div class="form-group">
                                <button class="general_btn_lg" type="submit">@lang('translate.reset_password')</button>
                            </div>
