    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item menu-item-submenu {{@$is_active=='tenants'?'menu-item-active menu-item-open menu-item-here':''}} "
                    aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                                                    <span class="svg-icon menu-icon">
                                                        <i class="fa fa-users"></i>
                                                    </span>
                        <span class="menu-text">@lang('panel.tenants')</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            <li class="menu-item {{@$route_name =='panel.tenants.index'?'menu-item-active':''}}"
                                aria-haspopup="true">
                                <a href="{{route('panel.tenants.index')}}" class="menu-link">
                            ...
                            <li class="menu-item {{@$route_name =='panel.tenants.create' ||  @$route_name =='panel.tenants.edit' ?'menu-item-active':''}}"
                                aria-haspopup="true">
                                <a href="{{route('panel.tenants.create')}}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
